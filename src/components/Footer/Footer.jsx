...
const Footer = () => {
    ...
    return (  
            <div style={{ display:'flex', justifyContent: 'center', padding:'0.5rem'}} className={classes.glassEffect}>
                ...
                <a style={{textDecoration: 'none', color: '#000',fontSize:'1.2rem'}} href="https://github.com/shub0012/spacex-dashhttps://github.com/shub0012/spacex-dash">GitHub link for this project</a>
            </div>
    )
}
